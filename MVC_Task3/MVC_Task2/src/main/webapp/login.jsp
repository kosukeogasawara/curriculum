...
<link rel="stylesheet" href="/MVC_Task2/css/common.css">
<link rel="stylesheet" href="/MVC_Task2/css/login.css">
...
<body>
    ...
    <div class="div-login-form">
        <% if (requestStatus < 2 && !message.isEmpty()) { %>
            ...
            <div class="error-label"><p><%=message %></P></div>
            <br>
        <% } %>
        <!-- FIXME Step-1-3: actionに送信先URIを記述しなさい。 -->
        <!-- Tips: 「/このプロジェクト/web.xmlに記述されているservlet-name」 -->
        <form action="/MVC_Task2/employee2" method="post">
