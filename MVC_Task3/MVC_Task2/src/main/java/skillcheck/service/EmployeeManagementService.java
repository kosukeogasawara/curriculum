        ...
        try {
            ...
            if (this.reqStatus == 0) {
                ...
                case FIND_BY_EMPID_WITH_LIKE:
                    ...
                    Logger.log(new Throwable(), "reqStatus  = " + empResultList.stream());
            ...
            Logger.log(new Throwable(), "reqStatus  = " + this.responseBean.getEmplyeeBeanList().stream().findFirst().orElse(null));
