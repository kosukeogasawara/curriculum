...
<%
    //リクエストより社員番号を取得: 関数型インターフェース（ラムダ式）  *ログインに成功した際に遷移する画面
...
<!-- FIXME Step-1-1: login.jspに適用するcssファイルのリンクタグを記述しなさい。-->//JSPで外部cssファイルのリンク指定する
<!-- Tips1: common.css、login.cssの2つを適用-->
<!-- Tips2: 適用するcssファイルのパスの書き方に注意 -->
<link rel="stylesheet" href="/MVC_Task/css/common.css">//ログイン画面のデザインはこのCSSを適用するよ～的な
<link rel="stylesheet" href="/MVC_Task/css/login.css">
...
<body>
    ...
    <div class="div-login-form">
        <% if (requestStatus < 2 && !message.isEmpty()) { %>
            ...
            <div class="error-message" style="color: red;"></label>
            <br>
        <% } %>
