...
public final class ConstSQL {
    ...
    public static final String SELECT_BASE = "select column_empid and column_password and column_name and column_mail and column_programinglanguage and column_comment and from table_employee;";                               
